...
<body>
  <div class="header">
    <a href="home.php" class="logo"<?php if($active=='home') echo "class='logo2'"; ?>>HEMOLINK</a>
    ...
    <a href="why_donate_blood.php"  <?php if($active=='why') echo "class='act'"; ?>>Why Donate Blood</a>
      ...
      <a href="bblogin.php" <?php if($active=='contact') echo "class='act'"; ?>>Blood_Bank Login</a>
      <a href="hlogin.php" <?php if($active=='contact') echo "class='act'"; ?>>Hospital Login</a>
      <a href="dlogin.php" <?php if($active=='contact') echo "class='act'"; ?>>Donor Login</a>
      <a href="hdash.php" <?php if($active=='contact') echo "class='act'"; ?>>ho</a>
