...
<form action="haction.php" method="post">
  <div class="container">
    ...
    <label for="text"><b>Registration ID</b></label>
    ...
    <input type="text" placeholder="Enter number" name="contact_no" id="contact_no" required>
  ...
  <div class="container signin">
    <p>Already have an account? <a href="hlogin.php">Sign in</a>.</p>
  </div>
</form>
